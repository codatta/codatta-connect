...
// Configure wallet provider connection settings
...
// Helper function to generate SIWE message
...
export default function WalletQr(props: {
  ...
  // Initialize WalletConnect connection and handle signing process
  ...
  // Effect hooks for managing QR code and wallet connection
  useEffect(() => {
      ...
      <div className="xc-text-center">
        {error ? (
          ...
          <>
            {guideType === "scan" && (
              <p>
                Scan this QR code from your mobile wallet or phone's camera to
                connect.
              </p>
            )}
